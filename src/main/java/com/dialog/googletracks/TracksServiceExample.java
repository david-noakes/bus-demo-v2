...
public class TracksServiceExample {
  ...
  public static void main(String[] args) throws IOException, GeneralSecurityException {
   ...
   // Build service account credential.
    ...
    // Test5
    String method = GoogleTracksConstants.METHOD_LIST_COLLECTIONS;
  ...
  private void Test4(GoogleCredential credential) throws GeneralSecurityException, IOException {
      HttpTransport httpTransport = GoogleNetHttpTransport.newTrustedTransport();
      GoogleTracksCollectionList gtCollList = new GoogleTracksCollectionList();
...
//                        " \"0179f339ec9232ef\" ] }";
      ...
      gtCollList.get(1).getEntities().add(gtEnt);
